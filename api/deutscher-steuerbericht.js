/**
 * 🇩🇪 DEUTSCHER-STEUERBERICHT API - AGGRESSIVE PAGINATION (300.000+ Transaktionen)
 * 
 ...
 * ✅ ERC20 + Native Transfers (ETH/PLS)
 */
...
export default async function handler(req, res) {
  console.log('🔥🔥🔥 DEUTSCHER STEUERBERICHT - AGGRESSIVE PAGINATION (300.000+)! 🔥🔥🔥');
  ...
  try {
    ...
    console.log('🇩🇪 DEUTSCHER STEUERBERICHT PARAMS:', { 
    ...
    console.log(`✅ DEUTSCHER STEUERBERICHT GENERATED: ${categorizedTransactions.length.toLocaleString()} transactions`);
    ...
    return res.status(200).json({
      ...
      debug: {
        ...
        source: 'deutscher_steuerbericht_aggressive_pagination_300k',
        paginationInfo: {
    ...
    console.error('💥 DEUTSCHER STEUERBERICHT ERROR:', error);
