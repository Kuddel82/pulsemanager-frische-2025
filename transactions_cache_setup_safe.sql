/*
📊 SUPABASE: Transactions Cache Setup für TAX SERVICE - FIXED VERSION
...
-- 🗑️ LÖSCHE ALTE POLICIES (falls vorhanden)
...
DO $$
BEGIN
  RAISE NOTICE '✅ TRANSACTIONS CACHE SETUP COMPLETE (SAFE VERSION):';
