...
window.fetch = function(...args) {
	...
	// Sicherstellen, dass url ein String ist, bevor startsWith aufgerufen wird
	...
	return originalFetch.apply(this, args)
		...
		.catch(error => {
			// Sicherstellen, dass url ein String ist, bevor match aufgerufen wird
			if (!(typeof url === 'string' && url.match(/\.html?$/i))) {
				console.error(error);
			}
			throw error;
		});
